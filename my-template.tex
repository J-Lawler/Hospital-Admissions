...
\begin{titlepage}
  ...
  \end{figure}
  \vspace{2em}
  \textbf{\Huge{Projecting Hospitalisation in the Context of Scotland's Ageing Population}}\\[2em]
  \textbf{\LARGE{by}}\\
  \vspace{2em}
  \textbf{\LARGE{Jake Lawler}}\\
  \vspace{6.5em}
  ...
  \Large{June 2023}\\
  \vspace{3em}
  \Large{Supervised by\\Dr Vanda Inacio De Carvalho and Dr Simon Wood}
  \vfill
\end{titlepage}
%
\clearpage
